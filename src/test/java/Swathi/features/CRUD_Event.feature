Feature: As an admin user I should be able to create an event
    ...
    Scenario Outline: Add a new event without picture
        ...
        Examples:
            ...
            |Kanuma     |Festival |09/04/2024    |09/04/2024  |6-8PM            |Temple      |Kanuma follows Sankranti festival.|
...
#
#
#    Scenario Outline: Viewing the event as a backend admin user with valid serial number
#        When user selects the View option of <SerialNumber>
...
#
#
#    Scenario Outline: Editing the field of an event
