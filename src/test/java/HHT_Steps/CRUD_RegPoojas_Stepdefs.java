...
public class CRUD_RegPoojas_Stepdefs {
    WebDriver driver;
    ...
    public void clicksOnRegularPoojas() {
    ...
    public void iShouldNavigateToSpecialPoojasPage() {
        String ExpUrl = "https://www.hanumanhindutemple.org/test_mode/regular_poojas.php";
        String ActUrl = driver.getCurrentUrl();
        Assert.assertEquals(ActUrl, ExpUrl);
        System.out.println("Regular poojas url matched");
    }

    //    *********** View Poojas **********
    @When("user clicks on View of {string} of {string}")
    public void userClicksOnViewOfOf(String PoojaTitle, String PoojaServicesSection) {
    ...
    public void itShouldNavigateToTheSelectedPoojasPage() {
        String E = "View Events Details";
        WebElement V =driver.findElement(By.xpath("//div[@id='bar']"));
        String A = V.getText();
        Assert.assertEquals(E, A);
        System.out.println("View Events Details Page");
    }
    //************ Edit Poojas ************
